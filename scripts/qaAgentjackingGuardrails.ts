...
function testVersionMetadata(): void {
  ...
  assert(APP_STATUS.includes("Ruleta") || APP_STATUS.includes("ruleta"), "APP_STATUS debe mencionar la UI de ruleta de temporada.");
...
function testDocsArePresent(): void {
  ...
  const phaseDocPath = "docs/v0_23_2b_SEASON_LUCK_WHEEL_UI.md";
  ...
  assert(existsSync(join(ROOT, phaseDocPath)), "Debe existir docs/v0_23_2b_SEASON_LUCK_WHEEL_UI.md.");
