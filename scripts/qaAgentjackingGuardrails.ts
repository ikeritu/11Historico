...
function testDocsArePresent(): void {
  ...
  const phaseDocPath = "docs/v0_23_3b_HOOKS_SIMULATION_DEPS_CLEANUP.md";
  ...
  assert(existsSync(join(ROOT, phaseDocPath)), "Debe existir docs/v0_23_3b_HOOKS_SIMULATION_DEPS_CLEANUP.md.");
