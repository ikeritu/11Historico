...
function testReleaseDocsArePresent(): void {
  ...
  const releaseDocPath = "docs/v0_23_3_TECH_HEALTH_BASELINE.md";
  ...
  assert(existsSync(join(ROOT, releaseDocPath)), "Debe existir docs/v0_23_3_TECH_HEALTH_BASELINE.md.");
  logOk("README, CHANGELOG y doc de release apuntan a v0.23.3");
}
