...
function testReleaseDocsArePresent(): void {
  ...
  const releaseDocPath = "docs/v0_23_3a_MOBILE_VIEWPORT_FIX.md";
  ...
  assert(existsSync(join(ROOT, releaseDocPath)), "Debe existir docs/v0_23_3a_MOBILE_VIEWPORT_FIX.md.");
  logOk("README, CHANGELOG y doc de release apuntan a v0.23.3a");
}
