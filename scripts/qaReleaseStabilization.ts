...
function testReleaseDocsArePresent(): void {
  ...
  const releaseDocPath = "docs/v0_23_3b_HOOKS_SIMULATION_DEPS_CLEANUP.md";
  ...
  assert(existsSync(join(ROOT, releaseDocPath)), "Debe existir docs/v0_23_3b_HOOKS_SIMULATION_DEPS_CLEANUP.md.");
  logOk("README, CHANGELOG y doc de release apuntan a v0.23.3b");
}
